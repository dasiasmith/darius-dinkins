  ...
  return (
    <header className="bg-transparent md:sticky top-0 z-10">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <a
          href="#contact"
          className="inline-flex items-center bg-transparent border-0 py-1 px-3 focus:outline-none text-white hover:bg-gray-700 rounded text-base mt-4 md:mt-0"
        >
          Book Me?
          <ArrowRightIcon className="w-4 h-4 ml-1 book-me" />
        </a>
      </div>
    </header>
  );
